    ...
    return (
        <div id="home" className="section">
            <div className='page home-left'>
                <h1>Jangan Pernah Membeli Atau Menjual
                Barang Secara Online Tanpa 
                Menggunakan  Syawalrekber.com</h1>
                ...
                <label className='peran'>
                    <select name="peran" value={formData.peran} onChange={handleChange}>
                        <option value='' disabled selected>Saya Sebagai</option>
                ...
                <label className='ident'>
                    ...
                    <option value='' disabled selected>Beridentitas</option>
                ...
                <div className='buton'>
                <button type="submit" disabled={!isFormValid()}>Buat Rekber</button>
                </div>
            </form>
                </div>
            </div>
