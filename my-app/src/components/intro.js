  ...
  return (
    <div className='intro'>
     ...
     >Apa Itu Rekening Bersama Atau Rekber?</h1>
        ...
        data-aos-duration="1000"
        data-aos-offset="300"
        data-aos-delay="350" className='paragraff'> Syawalrekber.com menyediakan jasa sistem pembayaran dalam jual beli barang/jasa untuk membantu keamanan dan kenyamanan dalam bertransaksi jarak jauh. Dalam konteks bisnis antar-mitra, SyawalRekber.com berfungsi sebagai pihak ketiga untuk menampung dana selama masa jual beli.</p>
