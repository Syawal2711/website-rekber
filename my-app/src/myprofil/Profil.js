...
export default function Profil(){
  ...
  return (
    <div id='transaksi-saya'>
      ...
      <p style={{color:"#545454"}}>Selamat datang, <span style={{color:"black",fontWeight:"600"}}>{identitas.name ? identitas.name : decodedToken.email}</span></p>
      </div>
      <div className='container-transaksi' style={{ padding: '1rem' }}>
        ...
        <div className='line' style={{ padding: '1rem 0' }}>
          ...
          <p style={{ color: 'black', fontWeight: '600', paddingTop: '1rem' }}>{identitas.name ? identitas.name : 'Tidak Di Atur'}</p>
        </div>
        <div className='line' style={{ padding: '1rem 0' }}>
        ...
        <div style={{ padding: '1rem 0' }}>
          ...
          <p style={{ color: 'black', fontWeight: '600', paddingTop: '1rem' }}>{identitas.noHp? identitas.noHp:'Tidak Di Atur'}</p>
        </div>
      </div>
